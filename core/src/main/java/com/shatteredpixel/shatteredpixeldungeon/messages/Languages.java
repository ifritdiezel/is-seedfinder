...
public enum Languages {
	...
	TURKISH("türkçe",       "tr", Status.UNFINISHED, new String[]{"LokiofMillenium", "Mustafa.10", "T3kin5iZ", "emrebnk", "gorkem_yılmaz"}, new String[]{"AGORAAA", "AchernarPrime", "AcuriousPotato", "BurningDaylight", "MuratEfeYilmaz", "OzanAlkan", "TR_Muhittin", "Talha_0_0", "ahmetbakicakir", "akkaya.mustafa", "alikeremozfidan", "alpekin98", "denizakalin", "eraysall402", "erdemozdemir98", "hasantahsin160", "immortalsamuraicn", "kayikyaki", "melezorus34", "mitux", "mustafadoslu", "ryuga", "yasirckr85", "yukete"}),
	...
	UKRANIAN("українська",  "uk", Status.UNFINISHED, new String[]{"Oster", "Snikewin", "zhushman00"}, new String[]{"AlexFenixUA", "Dotsent", "Lyttym", "Mops", "Sadsaltan1", "TarasUA", "TheGuyBill", "Tomfire", "Volkov", "ZverWolf", "_bor_", "alexfenixva", "ddmaster3463", "filalex77", "holuydadko", "ingvarfed", "iu0v1", "lezzen", "myshokoleksander05", "oliolioxinfree", "qweez", "romanokurg", "so1der", "sterenkevicsasa", "vlisivka", "xojltoh", "yukete", "zhawty", "Мальвочка"}),
